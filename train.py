...
train_set = DatasetFromFolder(join('kill_me_baby_classification', 'train'), label_indices)
train_data_loader = DataLoader(dataset=train_set, batch_size=option.batchSize, shuffle=True)
test_set = DatasetFromFolder(join('kill_me_baby_classification', 'test'), label_indices)
